...
$(function() {
	...
	$(".nav-button, .menu-item").click(function() {
		$(".bar").toggleClass("animate");
		$("article").toggleClass("article-active");
		$(".menu").toggleClass("active");
	});

	$('.pricing-button').focus( function() {
		$(this).parent('.pricing-item').addClass('item-active');
	});

	$('.pricing-button').blur( function() {
		$(this).parent('.pricing-item').removeClass('item-active');
	});
