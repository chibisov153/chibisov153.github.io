document.addEventListener("DOMContentLoaded", () => {
  ...
  function validateElem(elem) {
    const dictionary = {
      ...
      passwordConfirmation: [copyPass === elem.a.value, "Пароль не совпадает"],
    ...
    return (() => {
      ...
      if (!name[0] && elem.a.value !== "") {
        ...
        formValidate.push(elem.a.name);
        if (elem.a.name === "password") {
          if (elem.a.type === "text") {
            arrPass[0].a.setAttribute("type", "password");
            arrPass[0].b.classList.remove("from-view-active");
          }
          copyPass = elem.a.value;
        }
      } else {
  ...
  function helpElem(elem) {
    const dictionary = {
      ...
      phone: [regExpPhone, "+7(123) 123 1234"],
      default: "default"
    };
    return (() => {
      let name = dictionary[elem.a.name] || dictionary["default"];
  ...
  function formSend(event) {
    ...
    if (!arrCheck.a.checked) {
      ...
      modalMessage("Заполните правильно форму!");
    } else {
    ...
    fromGroup.forEach(elem => {
      ...
      } else if (fromGroup.length !== formValidate.length) {
        modalMessage("Заполните правильно форму!");
      } else {
