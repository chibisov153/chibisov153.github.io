...
$(function() {
	...
	$('.hamburger-menu').on('click', function(){
		...
		$('.menu-2-items').toggleClass('animate');
	...
	$('.menu2-item').on('click', function(){
		...
		$('.menu-2-items').removeClass('animate');
